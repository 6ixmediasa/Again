...
public sealed record Target {
 ...
 public double X {get;init;} public double Y {get;init;} public double Confidence {get;init;}=1;
 public string? Template {get;init;} public string? Domain {get;init;}
}
...
public sealed record Step {
 ...
 public bool Enabled {get;init;}=true; public Target? Target {get;init;} public Dictionary<string,string> Args {get;init;}=[];
 public Predicate? When {get;init;} public int Retries {get;init;} public int TimeoutSeconds {get;init;}=30;
...
public sealed record Workflow {
 ...
 public string Description {get;init;}=""; public string Category {get;init;}="General"; public bool Favorite {get;init;} public bool Archived {get;init;}
...
public sealed record Settings {
 ...
 public string Theme {get;init;}="System"; public bool ReducedMotion {get;init;} public bool CaptureKeyboard {get;init;}
 public int TimeoutSeconds {get;init;}=30; public int RetryCount {get;init;}=1; public double Confidence {get;init;}=.9;
 public int JpegQuality {get;init;}=90; public bool PreserveMetadata {get;init;} public int HistoryRetentionDays {get;init;}=90;
...
public static class WorkflowJson {
 ...
 public static void Validate(Workflow w){
  ...
  foreach(var s in w.Steps){if(!Enum.IsDefined(s.Operation)||!Enum.IsDefined(s.Method)||s.Retries is <0 or >10||s.TimeoutSeconds is <1 or >3600)throw new InvalidDataException("Invalid step settings.");
