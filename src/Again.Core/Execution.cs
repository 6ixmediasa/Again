...
public sealed class ExecutionContext {
 public required string Input {get;init;} public required string Output {get;set;}
 public required Dictionary<string,string> Values {get;init;} public Dictionary<string,object> State {get;}=[];
