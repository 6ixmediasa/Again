...
public sealed class Recorder : IDisposable
{
    ...
    void OnFocus(object sender, AutomationFocusChangedEventArgs args)
    {
        if (field is not null && valueHandler is not null) { try { Automation.RemoveAutomationPropertyChangedEventHandler(field, valueHandler); } catch (ElementNotAvailableException) { } field = null; }
