...
public sealed class CoreTests : IDisposable
{
    ...
    [Theory]
    [InlineData("https://example.com", "https://example.com/path", true)]
    [InlineData("https://example.com", "https://example.com.evil.test", false)]
    ...
    [Theory]
    [InlineData(400, 600, "text")]
    [InlineData(600, 400, "crop")]
    [InlineData(500, 500, "both")]
    [InlineData(600, 400, "both")]
    [InlineData(400, 600, "logo")]
